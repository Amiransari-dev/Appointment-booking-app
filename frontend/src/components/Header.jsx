...
const Header = () => {
    return (
        <div className='flex flex-col md:flex-row flex-wrap  border-4 border-gray-500 rounded-lg px-6 md:px-10 lg:px-20 '>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-3  text-sm font-light bg-gray-200 rounded px-2'>
